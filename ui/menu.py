...
def mostrar_menu():
    while True:
        ...
        if opcion == "1":
            ...
            if cliente:
                print(f"Cliente encontrado: {cliente.nombre} - Cédula: {cliente.cedula}")
            else:
            ...
            if cliente:
                ...
                print(f"Factura creada para el cliente {cliente.nombre} en la fecha {fecha}.")
            else:
                print("Cliente no encontrado.")
            ...
            if cliente:
                if cliente.facturas:
                    ...
                    factura = cliente.facturas[factura_index]
                    ...
                    if tipo_producto == "1":
                        ...
                        registro_ICA = input("Ingrese el registro ICA: ")
                        frecuencia_aplicacion = int(input("Ingrese la frecuencia de aplicación (días): "))
                        fecha_ultima_aplicacion = date.fromisoformat(
                            input("Ingrese la fecha de última aplicación (YYYY-MM-DD): "))
                        producto = Fertilizante(nombre, precio, registro_ICA, frecuencia_aplicacion,
